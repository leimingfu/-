package com.Healthy.MainPage.lib;
...
import static com.Healthy.MainPage.lib.SportStepJsonUtils.getCalorieByStep;
import static com.Healthy.MainPage.lib.SportStepJsonUtils.getDistanceByStep;
...
//        JLogger.i(TAG, "onStartCommand CurrStep :" + CURRENT_STEP + "   mSeparate:" + mSeparate + "    mBoot:" + mBoot);
    ...
    private synchronized void initNotification(int currentStep) {
        Log.e("Service111","进入initNotification");
