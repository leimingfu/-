 ...
 * Original file: /home/leimingfu/文档/AndroidStudioProjects/TodayTest1/TodayTest/lib-todaystepcounter/src/main/aidl/com/Healthy/MainPage/lib/ISportStepInterface.aidl
 */
package MainPage.lib;
public interface ISportStepInterface extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements MainPage.lib.ISportStepInterface
{
private static final java.lang.String DESCRIPTOR = "MainPage.lib.ISportStepInterface";
...
/**
 * Cast an IBinder object into an MainPage.lib.ISportStepInterface interface,
 * generating a proxy if needed.
 */
public static MainPage.lib.ISportStepInterface asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof MainPage.lib.ISportStepInterface))) {
return ((MainPage.lib.ISportStepInterface)iin);
}
return new MainPage.lib.ISportStepInterface.Stub.Proxy(obj);
}
...
private static class Proxy implements MainPage.lib.ISportStepInterface
{
